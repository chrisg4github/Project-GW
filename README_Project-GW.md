...
What is difference between climate and weather?  The definition of climate is the composite or generally prevailing weather conditions of a region, as temperature, air pressure, humidity, precipitation, sunshine, cloudiness, and winds, throughout the year, averaged over a series of years, and the definition of weather is the state of the atmosphere with respect to wind, temperature, cloudiness, moisture, and pressure.  From the definitions, climate and weather are similiar and cover similar areas of knowledge, but generally climate would be used in the context of time in terms of years or longer whereas weather is more short term like a day, a week or a season.  This is an important distinction in the discusion of climate change and global warming.  For instance, Senator Jim Inhofe's "Snowball on the Senate floor" speech.  His speech was taken as trying to deny climate change by the fact that he pulled a snowball out of a plastic bag in February of 2014.  A snowball generally is the result of cold temperatures that cause precipitation to freeze into ice crytals as it falls to the ground.  This is a weather phenomenon, and is generally a short term event, and it is an example of the difficulty of discussing these controversial, difficult to understand, and quantify subjects, but having some defintions will help us keep the discussion in the same ballpark.  The Climate Change ~ Global Warming disagreement won't be settled by this project, but we hope to shed some light on the subject.  Below are some details on the work involved behind the visualizations.
